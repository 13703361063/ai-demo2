...
const _NjmTL7 = defineEventHandler((event) => {
  ...
  setCookie(event, COOKIE_NAME$1, id, {
    httpOnly: true,
    sameSite: "lax",
    path: "/",
    secure: false,
...
async function requireSessionId(event) {
...
function createDashScopeClient(event) {
...
const chat_post = defineEventHandler(async (event) => {
  ...
  if (!(body == null ? void 0 : body.conversationId) || typeof body.conversationId !== "string") {
    throw createError({
      statusCode: 400,
  ...
  const config = useRuntimeConfig(event);
  const lastUser = (_b = (_a = [...body.messages].reverse().find((m) => m.role === "user")) == null ? void 0 : _a.content) == null ? void 0 : _b.trim();
  if (lastUser) {
  ...
  try {
    ...
    const statusCode = Number(error == null ? void 0 : error.status) || Number((_c = error == null ? void 0 : error.response) == null ? void 0 : _c.status) || 500;
    const message = (error == null ? void 0 : error.message) || ((_d = error == null ? void 0 : error.error) == null ? void 0 : _d.message) || (statusCode === 402 ? "Insufficient Balance" : "Upstream provider error");
    throw createError({
      statusCode,
    ...
    async start(controller) {
      ...
      try {
        ...
        for await (const part of completion) {
          const delta = (_c2 = (_b2 = (_a2 = part.choices) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.delta) == null ? void 0 : _c2.content;
          if (delta) {
            assistantText += delta;
...
const conversations_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: conversations_post
}, Symbol.toStringTag, { value: 'Module' }));
