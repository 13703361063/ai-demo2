declare global {
  ...
  const requireSessionId: typeof import('../../server/utils/session').requireSessionId
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'F:/xcx-demo/ai-chat-assistant/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'F:/xcx-demo/ai-chat-assistant/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { prisma } from 'F:/xcx-demo/ai-chat-assistant/server/utils/prisma';
export { requireSessionId } from 'F:/xcx-demo/ai-chat-assistant/server/utils/session';